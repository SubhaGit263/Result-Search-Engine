...
$sql="SELECT rName,rEmail,rPass FROM user WHERE rName='".$rName."' AND rEmail='".$rEmail."' AND rPass='".$rPass."'";
...
<title>www.userloginpage.com</title>
</head>
<body>
<div class="container">
<div class="row">
...
<a href="userregistration.php" class="btn btn-info">Back To Registration Page</a>
</form>
