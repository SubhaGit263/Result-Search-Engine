...
<h5>Welcome to change password portal</h5>
...
<a href="userprofile.php" class="btn btn-warning">Back to Profile page</a>
</div>
</div>
</div>
...
if($rPass==$rConPass)
{
$sql="UPDATE user SET rPass='$rPass',rConPass='$rConPass' WHERE Srno='".$Srno."'";
if(mysqli_query($conn,$sql))
{
echo '<div class="alert alert-success mt-3 text-center">Password updated successfully</div>';
}
}
else
{
