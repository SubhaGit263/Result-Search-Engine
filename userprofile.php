...
$sql="SELECT *FROM user WHERE rEmail='".$rEmail."'";
...
<title>www.UserProfile.com</title>
</head>
<body>
...
<a href="userlogout.php" class="btn btn-info">Logout</a>
<a href="userchangepass.php" class="btn btn-info">Change Password</a>
<a href="usercheckresult.php" class="btn btn-info">Check Result</a>
...
{
if(($_REQUEST['rName']=="")||($_REQUEST['rEmail']=="")||($_REQUEST['rPhno']==""))
{
...
$sql="UPDATE user SET rName='$rName',rEmail='$rEmail',rPhno='$rPhno' WHERE Srno='".$Srno."'";
